...
| Build | Gradle Kotlin DSL, Gradle 9.5.0, Android Gradle Plugin 9.3.0, JDK 17 |
...
The supported range is Android 8.0 (API 26) through Android 17 (API 37). Version-specific checks are documented in the same checklist.
