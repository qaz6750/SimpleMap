...
private val SimpleMapColorScheme = lightColorScheme(
    ...
    secondary = SimpleMapBlue,
    onSecondary = Color.White,
    secondaryContainer = SimpleMapBlueLight,
    onSecondaryContainer = Color(0xFF003A81),
...
private val SimpleMapDarkColorScheme = darkColorScheme(
    ...
    secondary = SimpleMapBlueNight,
    onSecondary = Color(0xFF00315E),
    secondaryContainer = Color(0xFF0B4EAE),
